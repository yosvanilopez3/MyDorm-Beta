...
class PaymentInfoVC: UIViewController, STPPaymentContextDelegate {
    ...
    init(product: String, price: Int, settings: Settings) {
        ...
        BackendAPIAdapter.sharedClient.baseURLString = self.backendBaseURL
        ...
        let paymentContext = STPPaymentContext(apiAdapter: BackendAPIAdapter.sharedClient,
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didCreatePaymentResult paymentResult: STPPaymentResult, completion: @escaping STPErrorBlock) {
        BackendAPIAdapter.sharedClient.completeCharge(paymentResult, amount: self.paymentContext.paymentAmount,
